...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_pdm_2eproto DllExport

namespace protobuf_pdm_2eproto {
// Internal implementation detail -- do not use these members.
struct DllExport TableStruct {
...
void DllExport AddDescriptors();
}  // namespace protobuf_pdm_2eproto
namespace platform {
class Information;
class InformationDefaultTypeInternal;
DllExport extern InformationDefaultTypeInternal _Information_default_instance_;
class Machine;
class MachineDefaultTypeInternal;
DllExport extern MachineDefaultTypeInternal _Machine_default_instance_;
class Machine_CPU;
class Machine_CPUDefaultTypeInternal;
DllExport extern Machine_CPUDefaultTypeInternal _Machine_CPU_default_instance_;
class Machine_GPU;
class Machine_GPUDefaultTypeInternal;
DllExport extern Machine_GPUDefaultTypeInternal _Machine_GPU_default_instance_;
class Machine_GPU_Driver;
class Machine_GPU_DriverDefaultTypeInternal;
DllExport extern Machine_GPU_DriverDefaultTypeInternal _Machine_GPU_Driver_default_instance_;
class Machine_Monitor;
class Machine_MonitorDefaultTypeInternal;
DllExport extern Machine_MonitorDefaultTypeInternal _Machine_Monitor_default_instance_;
class Machine_NetworkAdapter;
class Machine_NetworkAdapterDefaultTypeInternal;
DllExport extern Machine_NetworkAdapterDefaultTypeInternal _Machine_NetworkAdapter_default_instance_;
class Machine_VM;
class Machine_VMDefaultTypeInternal;
DllExport extern Machine_VMDefaultTypeInternal _Machine_VM_default_instance_;
class OS;
class OSDefaultTypeInternal;
DllExport extern OSDefaultTypeInternal _OS_default_instance_;
class OS_GraphicsAPIs;
class OS_GraphicsAPIsDefaultTypeInternal;
DllExport extern OS_GraphicsAPIsDefaultTypeInternal _OS_GraphicsAPIs_default_instance_;
class OS_Wine;
class OS_WineDefaultTypeInternal;
DllExport extern OS_WineDefaultTypeInternal _OS_Wine_default_instance_;
class SemanticVersion;
class SemanticVersionDefaultTypeInternal;
DllExport extern SemanticVersionDefaultTypeInternal _SemanticVersion_default_instance_;
}  // namespace platform
namespace google {
namespace protobuf {
template<> DllExport ::platform::Information* Arena::CreateMaybeMessage<::platform::Information>(Arena*);
template<> DllExport ::platform::Machine* Arena::CreateMaybeMessage<::platform::Machine>(Arena*);
template<> DllExport ::platform::Machine_CPU* Arena::CreateMaybeMessage<::platform::Machine_CPU>(Arena*);
template<> DllExport ::platform::Machine_GPU* Arena::CreateMaybeMessage<::platform::Machine_GPU>(Arena*);
template<> DllExport ::platform::Machine_GPU_Driver* Arena::CreateMaybeMessage<::platform::Machine_GPU_Driver>(Arena*);
template<> DllExport ::platform::Machine_Monitor* Arena::CreateMaybeMessage<::platform::Machine_Monitor>(Arena*);
template<> DllExport ::platform::Machine_NetworkAdapter* Arena::CreateMaybeMessage<::platform::Machine_NetworkAdapter>(Arena*);
template<> DllExport ::platform::Machine_VM* Arena::CreateMaybeMessage<::platform::Machine_VM>(Arena*);
template<> DllExport ::platform::OS* Arena::CreateMaybeMessage<::platform::OS>(Arena*);
template<> DllExport ::platform::OS_GraphicsAPIs* Arena::CreateMaybeMessage<::platform::OS_GraphicsAPIs>(Arena*);
template<> DllExport ::platform::OS_Wine* Arena::CreateMaybeMessage<::platform::OS_Wine>(Arena*);
template<> DllExport ::platform::SemanticVersion* Arena::CreateMaybeMessage<::platform::SemanticVersion>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace platform {
...
DllExport bool OS_Kind_IsValid(int value);
...
DllExport const ::google::protobuf::EnumDescriptor* OS_Kind_descriptor();
...
class DllExport SemanticVersion : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.SemanticVersion) */ {
 public:
  SemanticVersion();
...
class DllExport OS_GraphicsAPIs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.OS.GraphicsAPIs) */ {
 public:
  OS_GraphicsAPIs();
...
class DllExport OS_Wine : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.OS.Wine) */ {
 public:
  OS_Wine();
  virtual ~OS_Wine();
...
class DllExport OS : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.OS) */ {
 public:
  OS();
  virtual ~OS();
...
class DllExport Machine_CPU : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.Machine.CPU) */ {
 public:
  Machine_CPU();
  virtual ~Machine_CPU();
...
class DllExport Machine_VM : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.Machine.VM) */ {
 public:
  Machine_VM();
  virtual ~Machine_VM();
...
class DllExport Machine_Monitor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.Machine.Monitor) */ {
 public:
  Machine_Monitor();
...
class DllExport Machine_GPU_Driver : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.Machine.GPU.Driver) */ {
 public:
  Machine_GPU_Driver();
...
class DllExport Machine_GPU : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.Machine.GPU) */ {
 public:
  Machine_GPU();
  virtual ~Machine_GPU();
...
class DllExport Machine_NetworkAdapter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.Machine.NetworkAdapter) */ {
 public:
...
class DllExport Machine : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.Machine) */ {
 public:
  Machine();
  virtual ~Machine();
...
class DllExport Information : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:platform.Information) */ {
 public:
  Information();
  virtual ~Information();
